...
<body>
	...
	<div class="admin-container">
		<div class="admin-header">
			...
			<p>This page allows you to update category from the database.</p>
		...
		<div class="form-container">
			...
			<%
				...
				%>
				<label class="form-label">Category Name:</label> <input type="text"	name="categoryName" class="form-input" value="<%=categoryName%>"> 
				<label class="form-label">Category Image:</label> <input type="url"	name="categoryImage" class="form-input" value="<%=categoryImage%>"> 
